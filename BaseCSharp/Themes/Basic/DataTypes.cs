...
public class DataTypes
{
    public void Run()
    {
        ...
        Console.WriteLine("bool System.Boolean 1byte");
        bool isTrue = true;
        ...
        Console.WriteLine("byte System.Byte 1bit от 0 - 255");
        byte minByte = 0;
        ...
        Console.WriteLine("byte Sysyem.SByte 1byte от -128-127");
        sbyte minSByte = -128;
        ...
        Console.WriteLine("short System.Int16 2byte хранит от -32768 - 32767");
        ...
        Console.WriteLine("ushort System.UInt16 2byte хранит от 0 -65535");
        ushort minUShort = 0;
        ...
        Console.WriteLine("int System.Int32 4byte хранит -2147483648 до 2147483647");
        ...
        Console.WriteLine("long System.Int64 8byte хранит от –9 223 372 036 854 775 808 до 9 223 372 036 854 775 807");
        ...
        Console.WriteLine("ulong System.UInt64 8byte хранит от 0 - 18446744073709551615");
        ulong minULong = 0UL;
        ...
        Console.WriteLine("float System.Single 4byte от -3.4*10^38 до 3.4*10^38");
        ...
        Console.WriteLine("double System.Double 8byte от \u00b15.0*10-324 до \u00b11.7*10308");
        ...
        Console.WriteLine("decimal System.Decimal 16byte от \u00b11.0*10-28 до \u00b17.9228*1028 16 знаков после запятой");
        ...
        Console.WriteLine("char System.Char 2byte - хранит литералы символов");
        char a = 'A';
        System.Char b = '\x5A';
        Console.WriteLine(a);
        Console.WriteLine(b);
        ...
        Console.WriteLine("string System.String - хранит строковые литералы");
        string str = "Строка";
        ...
        Console.WriteLine("object Sysyem.Object - 4byte на 32 разрядных системах 8 - на 64.");
        ...
        Console.WriteLine("строка с неявной типизацией: " + str3);
